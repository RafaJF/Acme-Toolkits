...
<acme:form>
	...
	<acme:input-checkbox code="authenticated.announcement.form.label.criticalFlag" path="criticalFlag"/>
	<acme:input-textbox code="authenticated.announcement.form.label.info" path="info"/>
</acme:form>